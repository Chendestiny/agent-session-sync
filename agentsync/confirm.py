...
# 默认同步源（dsh 是目标不是源；kimi/grok/copilot/gemini/cline/pi 占位无 reader，0 会话不产出）
SYNC_SOURCES = ["zcode", "hermes", "codex", "workbuddy", "workbuddy-ai", "kilo", "claude", "opencode", "qoder", "openclaw",
